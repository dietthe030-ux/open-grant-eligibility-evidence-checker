...
- Runner-bundle provenance: official `genlayerlabs/genvm-manager` release `v0.6.0-rc5`, official asset `genvm-universal.tar.xz` at `https://github.com/genlayerlabs/genvm-manager/releases/download/v0.6.0-rc5/genvm-universal.tar.xz`, official/download SHA-256 `BD30580F911338D5533460ECA8ED714DEC371DE5803C04E41DBB96430AEA7B6E`. The retained local download is named `genvm-universal-v0.6.0-rc5.download.tar.xz` and has that same hash; the materialized local processed archive `genvm-universal-v0.6.0-rc5.tar.xz` is a different artifact with SHA-256 `38F4F12D8C26866C2A43BA84F255DF1977A3BA2CF2D911C74B411F279B5E975A`. `GENVM_VERSION=v0.6.0-rc5` selects the pinned `py-genlayer:5jycge4q8k23462jtb0b9fyey1s9qz928sz2nbrd9mg4sxqg2qng` dependency; the two local filenames and digests are not conflated.
