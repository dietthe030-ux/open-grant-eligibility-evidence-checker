...
- Runner-bundle provenance: official `genlayerlabs/genvm-manager` release `v0.6.0-rc5`, asset `genvm-universal-v0.6.0-rc5.tar.xz`, SHA-256 `BD30580F911338D5533460ECA8ED714DEC371DE5803C04E41DBB96430AEA7B6E`, selected with `GENVM_VERSION=v0.6.0-rc5`; it contains the pinned `py-genlayer:5jycge4q8k23462jtb0b9fyey1s9qz928sz2nbrd9mg4sxqg2qng` dependency.
